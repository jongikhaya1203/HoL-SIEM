<?php
/**
 * ARM Database Setup Script
 * Run this once to create all ARM tables
 */
...
try {
    ...
    // Create arm_users
    $pdo->exec("CREATE TABLE arm_users (
    ...
    echo "Created table: arm_users\n";

    // Create arm_roles
    $pdo->exec("CREATE TABLE arm_roles (
        id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    echo "Created table: arm_roles\n";

    // Create arm_groups
    $pdo->exec("CREATE TABLE arm_groups (
        id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    echo "Created table: arm_groups\n";

    // Create arm_resources
    $pdo->exec("CREATE TABLE arm_resources (
        id INT AUTO_INCREMENT PRIMARY KEY,
        ...
        compliance_frameworks VARCHAR(255) DEFAULT NULL,
        last_audit_date DATE DEFAULT NULL,
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
        updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
    ) ENGINE=InnoDB");
    echo "Created table: arm_resources\n";

    // Create arm_permissions
    $pdo->exec("CREATE TABLE arm_permissions (
        id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    echo "Created table: arm_permissions\n";

    // Create arm_user_roles
    $pdo->exec("CREATE TABLE arm_user_roles (
        id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    echo "Created table: arm_user_roles\n";

    // Create arm_user_groups
    $pdo->exec("CREATE TABLE arm_user_groups (
        id INT AUTO_INCREMENT PRIMARY KEY,
        user_id INT NOT NULL,
    ...
    echo "Created table: arm_user_groups\n";

    // Create arm_role_permissions
    $pdo->exec("CREATE TABLE arm_role_permissions (
        id INT AUTO_INCREMENT PRIMARY KEY,
        role_id INT NOT NULL,
    ...
    echo "Created table: arm_role_permissions\n";

    // Create arm_access_requests
    $pdo->exec("CREATE TABLE arm_access_requests (
        id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    echo "Created table: arm_access_requests\n";

    // Create arm_audit_log
    $pdo->exec("CREATE TABLE arm_audit_log (
    ...
    echo "Created table: arm_audit_log\n";

    // Create arm_access_reviews
    $pdo->exec("CREATE TABLE arm_access_reviews (
        id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    echo "Created table: arm_access_reviews\n";

    // Create arm_violations
    $pdo->exec("CREATE TABLE arm_violations (
        id INT AUTO_INCREMENT PRIMARY KEY,
        user_id INT DEFAULT NULL,
    ...
    echo "Created table: arm_violations\n";

    // Create arm_policies
    $pdo->exec("CREATE TABLE arm_policies (
        id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    echo "Created table: arm_policies\n";
    ...
    // Permissions
    $pdo->exec("INSERT INTO arm_permissions (permission_name, permission_code, description, permission_type) VALUES
    ...
    // Roles
    $pdo->exec("INSERT INTO arm_roles (role_name, role_code, description, role_type, risk_level, requires_approval) VALUES
    ...
    // Users
    $pdo->exec("INSERT INTO arm_users (username, email, full_name, department, job_title, status, user_type, mfa_enabled, risk_score) VALUES
    ...
    // Groups
    $pdo->exec("INSERT INTO arm_groups (group_name, group_code, description, group_type) VALUES
    ...
    echo "Inserted groups\n";

    // Resources
    $pdo->exec("INSERT INTO arm_resources (resource_name, resource_type, resource_path, classification, sensitivity_level, compliance_frameworks) VALUES
    ...
    echo "Inserted resources\n";

    // Violations
    $pdo->exec("INSERT INTO arm_violations (user_id, violation_type, severity, description, status) VALUES
    ...
    echo "Inserted violations\n";

    // Policies
    $pdo->exec("INSERT INTO arm_policies (policy_name, policy_type, description, policy_rules, enforcement_mode) VALUES
    ...
    echo "Inserted policies\n";

    // Access Requests
    $pdo->exec("INSERT INTO arm_access_requests (request_number, requester_id, request_type, target_id, justification, duration_days, status, priority) VALUES
    ...
    echo "Inserted access requests\n";

    echo "\n</pre>";
    echo "<h2 style='color: green;'>Setup Complete!</h2>";
    echo "<p><a href='modules/arm.php'>Go to Access Rights Manager</a></p>";
